...
def generate_id_card(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            page1_path = finders.find('IdInfo/images/id_Page1.jpg')
            page2_path = finders.find('IdInfo/images/id_Page2.jpg')
            ...
            template_pdf_path = finders.find('IdInfo/images/sample1.pdf')
    ...
    return render(request, 'idInfo/generate_id_card.html', {'form': form})
...
def modified_id_card(request):
    ...
    return render(request, 'idInfo/success.html', {
